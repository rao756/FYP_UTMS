...
import { Check, CheckCheck, Ellipsis, Trash2, User } from 'lucide-react';
import {
  Dialog,
  DialogFooter,
  DialogHeader,
...
import UserDetailsDialog from '../users/user-details';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const UserRequests = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      setUsers(res.data.users.filter((user: any) => user.isActive === false));
    } catch (error) {
              ...
              <TableRow className="cursor-pointer" key={index}>
                ...
                >
                  <Avatar className="size-9">
                    ...
                    <AvatarFallback className="border border-muted-foreground text-muted-foreground">
                ...
                <TableCell className="flex justify-center gap-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem
                        onClick={() => {
                          !user.isActive && handleApprove(user);
                        }}
                      >
                        <Button
                          variant={'default'}
                        ...
                        >
                          {user.isActive ? <CheckCheck /> : <Check />}
                        </Button>
                        Approve
                      </DropdownMenuItem>
